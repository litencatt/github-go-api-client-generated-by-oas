...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    path := "path_example" // string | path parameter
    reposDeleteFileRequest := *github.NewReposDeleteFileRequest("Message_example", "Sha_example") // ReposDeleteFileRequest | 
...
func main() {
    owner := "owner_example" // string | The account owner of the repository. The name is not case sensitive.
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    reposGenerateReleaseNotesRequest := *github.NewReposGenerateReleaseNotesRequest("TagName_example") // ReposGenerateReleaseNotesRequest | 
...
func main() {
    owner := "owner_example" // string | The account owner of the repository. The name is not case sensitive.
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    reposMergeRequest := *github.NewReposMergeRequest("Base_example", "Head_example") // ReposMergeRequest | 
...
func main() {
    owner := "owner_example" // string | The account owner of the repository. The name is not case sensitive.
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    reposMergeUpstreamRequest := *github.NewReposMergeUpstreamRequest("Branch_example") // ReposMergeUpstreamRequest | 
...
> []Team ReposRemoveTeamAccessRestrictions(ctx, owner, repo, branch).ReposSetTeamAccessRestrictionsRequest(reposSetTeamAccessRestrictionsRequest).Execute()
...
func main() {
    ...
    configuration := github.NewConfiguration()
    apiClient := github.NewAPIClient(configuration)
    resp, r, err := apiClient.ReposApi.ReposRemoveTeamAccessRestrictions(context.Background(), owner, repo, branch).ReposSetTeamAccessRestrictionsRequest(reposSetTeamAccessRestrictionsRequest).Execute()
    if err != nil {
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    branch := "branch_example" // string | The name of the branch.
    reposRenameBranchRequest := *github.NewReposRenameBranchRequest("NewName_example") // ReposRenameBranchRequest | 
...
func main() {
    owner := "owner_example" // string | The account owner of the repository. The name is not case sensitive.
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    reposReplaceAllTopicsRequest := *github.NewReposReplaceAllTopicsRequest([]string{"Names_example"}) // ReposReplaceAllTopicsRequest | 
...
func main() {
    owner := "owner_example" // string | The account owner of the repository. The name is not case sensitive.
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    reposTransferRequest := *github.NewReposTransferRequest("NewOwner_example") // ReposTransferRequest | 
...
func main() {
    owner := "owner_example" // string | The account owner of the repository. The name is not case sensitive.
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    reposUpdateRequest := *github.NewReposUpdateRequest() // ReposUpdateRequest |  (optional)
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    branch := "branch_example" // string | The name of the branch.
    reposUpdateBranchProtectionRequest := *github.NewReposUpdateBranchProtectionRequest("TODO", false, "TODO", "TODO") // ReposUpdateBranchProtectionRequest | 
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    commentId := int32(56) // int32 | The unique identifier of the comment.
    reposUpdateCommitCommentRequest := *github.NewReposUpdateCommitCommentRequest("Body_example") // ReposUpdateCommitCommentRequest | 
...
func main() {
    owner := "owner_example" // string | The account owner of the repository. The name is not case sensitive.
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    reposUpdateInformationAboutPagesSiteRequest := *github.NewReposUpdateInformationAboutPagesSiteRequest() // ReposUpdateInformationAboutPagesSiteRequest | 
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    invitationId := int32(56) // int32 | The unique identifier of the invitation.
    reposUpdateInvitationRequest := *github.NewReposUpdateInvitationRequest() // ReposUpdateInvitationRequest |  (optional)
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    branch := "branch_example" // string | The name of the branch.
    reposUpdatePullRequestReviewProtectionRequest := *github.NewReposUpdatePullRequestReviewProtectionRequest() // ReposUpdatePullRequestReviewProtectionRequest |  (optional)
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    releaseId := int32(56) // int32 | The unique identifier of the release.
    reposUpdateReleaseRequest := *github.NewReposUpdateReleaseRequest() // ReposUpdateReleaseRequest |  (optional)
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    assetId := int32(56) // int32 | The unique identifier of the asset.
    reposUpdateReleaseAssetRequest := *github.NewReposUpdateReleaseAssetRequest() // ReposUpdateReleaseAssetRequest |  (optional)
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    branch := "branch_example" // string | The name of the branch.
    reposUpdateStatusCheckProtectionRequest := *github.NewReposUpdateStatusCheckProtectionRequest() // ReposUpdateStatusCheckProtectionRequest |  (optional)
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    hookId := int32(56) // int32 | The unique identifier of the hook.
    reposUpdateWebhookRequest := *github.NewReposUpdateWebhookRequest() // ReposUpdateWebhookRequest | 
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    hookId := int32(56) // int32 | The unique identifier of the hook.
    reposUpdateWebhookConfigForRepoRequest := *github.NewReposUpdateWebhookConfigForRepoRequest() // ReposUpdateWebhookConfigForRepoRequest |  (optional)
