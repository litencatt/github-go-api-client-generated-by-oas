...
func main() {
    ...
    status := "status_example" // string | Returns workflow runs with the check run `status` or `conclusion` that you specify. For example, a conclusion can be `success` or a status can be `in_progress`. Only GitHub can set a status of `waiting` or `requested`. For a list of the possible `status` and `conclusion` options, see \"[Create a check run](https://docs.github.com/rest/reference/checks#create-a-check-run).\" (optional)
    perPage := int32(56) // int32 | The number of results per page (max 100). (optional) (default to 30)
    page := int32(56) // int32 | Page number of the results to fetch. (optional) (default to 1)
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    jobId := int32(56) // int32 | The unique identifier of the job.
    actionsReRunJobForWorkflowRunRequest := *github.NewActionsReRunJobForWorkflowRunRequest() // ActionsReRunJobForWorkflowRunRequest |  (optional)
...
func main() {
    ...
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    runId := int32(56) // int32 | The unique identifier of the workflow run.
    actionsReviewPendingDeploymentsForRunRequest := *github.NewActionsReviewPendingDeploymentsForRunRequest([]int32{int32(161171787)}, "approved", "Ship it!") // ActionsReviewPendingDeploymentsForRunRequest | 
...
func main() {
    enterprise := "enterprise_example" // string | The slug version of the enterprise name. You can also substitute this value with the enterprise id.
    actionsOidcCustomIssuerPolicyForEnterprise := *github.NewActionsOidcCustomIssuerPolicyForEnterprise() // ActionsOidcCustomIssuerPolicyForEnterprise | 
...
func main() {
    org := "org_example" // string | The organization name. The name is not case sensitive.
    selectedActions := *github.NewSelectedActions() // SelectedActions |  (optional)
...
func main() {
    owner := "owner_example" // string | The account owner of the repository. The name is not case sensitive.
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    optOutOidcCustomSub := *github.NewOptOutOidcCustomSub(false) // OptOutOidcCustomSub | 
...
func main() {
    enterprise := "enterprise_example" // string | The slug version of the enterprise name. You can also substitute this value with the enterprise id.
    actionsSetDefaultWorkflowPermissions := *github.NewActionsSetDefaultWorkflowPermissions() // ActionsSetDefaultWorkflowPermissions | 
...
func main() {
    org := "org_example" // string | The organization name. The name is not case sensitive.
    actionsSetDefaultWorkflowPermissions := *github.NewActionsSetDefaultWorkflowPermissions() // ActionsSetDefaultWorkflowPermissions |  (optional)
...
func main() {
    org := "org_example" // string | The organization name. The name is not case sensitive.
    actionsSetGithubActionsPermissionsOrganizationRequest := *github.NewActionsSetGithubActionsPermissionsOrganizationRequest(github.enabled-repositories("all")) // ActionsSetGithubActionsPermissionsOrganizationRequest | 
...
func main() {
    owner := "owner_example" // string | The account owner of the repository. The name is not case sensitive.
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    actionsSetGithubActionsPermissionsRepositoryRequest := *github.NewActionsSetGithubActionsPermissionsRepositoryRequest(false) // ActionsSetGithubActionsPermissionsRepositoryRequest | 
...
func main() {
    org := "org_example" // string | The organization name. The name is not case sensitive.
    runnerGroupId := int32(56) // int32 | Unique identifier of the self-hosted runner group.
    actionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequest := *github.NewActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequest([]int32{int32(123)}) // ActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequest | 
...
func main() {
    org := "org_example" // string | The organization name. The name is not case sensitive.
    secretName := "secretName_example" // string | The name of the secret.
    actionsSetSelectedReposForOrgSecretRequest := *github.NewActionsSetSelectedReposForOrgSecretRequest([]int32{int32(123)}) // ActionsSetSelectedReposForOrgSecretRequest | 
...
func main() {
    org := "org_example" // string | The organization name. The name is not case sensitive.
    actionsSetSelectedRepositoriesEnabledGithubActionsOrganizationRequest := *github.NewActionsSetSelectedRepositoriesEnabledGithubActionsOrganizationRequest([]int32{int32(123)}) // ActionsSetSelectedRepositoriesEnabledGithubActionsOrganizationRequest | 
...
func main() {
    org := "org_example" // string | The organization name. The name is not case sensitive.
    runnerGroupId := int32(56) // int32 | Unique identifier of the self-hosted runner group.
    enterpriseAdminSetSelfHostedRunnersInGroupForEnterpriseRequest := *github.NewEnterpriseAdminSetSelfHostedRunnersInGroupForEnterpriseRequest([]int32{int32(123)}) // EnterpriseAdminSetSelfHostedRunnersInGroupForEnterpriseRequest | 
...
func main() {
    owner := "owner_example" // string | The account owner of the repository. The name is not case sensitive.
    repo := "repo_example" // string | The name of the repository. The name is not case sensitive.
    actionsWorkflowAccessToRepository := *github.NewActionsWorkflowAccessToRepository("AccessLevel_example") // ActionsWorkflowAccessToRepository | 
...
func main() {
    org := "org_example" // string | The organization name. The name is not case sensitive.
    runnerGroupId := int32(56) // int32 | Unique identifier of the self-hosted runner group.
    actionsUpdateSelfHostedRunnerGroupForOrgRequest := *github.NewActionsUpdateSelfHostedRunnerGroupForOrgRequest("Name_example") // ActionsUpdateSelfHostedRunnerGroupForOrgRequest | 
