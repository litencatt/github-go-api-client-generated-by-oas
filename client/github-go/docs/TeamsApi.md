...
func main() {
    ...
    teamSlug := "teamSlug_example" // string | The slug of the team name.
    discussionNumber := int32(56) // int32 | The number that identifies the discussion.
    teamsUpdateDiscussionInOrgRequest := *github.NewTeamsUpdateDiscussionInOrgRequest() // TeamsUpdateDiscussionInOrgRequest |  (optional)
...
func main() {
    org := "org_example" // string | The organization name. The name is not case sensitive.
    teamSlug := "teamSlug_example" // string | The slug of the team name.
    teamsUpdateInOrgRequest := *github.NewTeamsUpdateInOrgRequest() // TeamsUpdateInOrgRequest |  (optional)
...
func main() {
    teamId := int32(56) // int32 | The unique identifier of the team.
    teamsUpdateLegacyRequest := *github.NewTeamsUpdateLegacyRequest("Name_example") // TeamsUpdateLegacyRequest | 
